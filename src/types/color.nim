...
template `+=`*(a: Color, b: Color): void = a = Vector[4, T](a) + Vector[4, T](b)
func `-`*[T](a, b: Color[T]): Color[T] = Vector[4, T](a) - Vector[4, T](b)
template `-=`*(a: Color, b: Color): void = a = a - b
func `*`*[T](a, b: Color[T]): Color[T] = Vector[4, T](a) * Vector[4, T](b)
func `*`*[T](a: Color[T], b: SomeNumber): Color[T] = Vector[4, T](a) * b
template `*=`*(a: Color, b: Color): void = a = a * b
template `*=`*(a: Color, b: SomeNumber): void = a = a * b
